var store = [{
        ...
        "excerpt":"Go through a brute force introduction into R, R Markdown, the RStudio IDE, version management with Git and GitHub’s classroom functionality to get ready for solving the upcoming assignment problems and submitting your solutions. Learning objectives At the end of this unit you should be able to tell the difference...","categories": ["01 Getting started"],
        "tags": ["Unit","01"],
        ...
        "excerpt":"Things you need for this exercise A shapefile of the study area (see below) The names of the required Sentinel 2 tiles - 37MCS and 37MBS Parameters to download Sentinel-2 data (see below) Data acquisition and first steps Download the shapefile for Kilimanjaro southern slope here. Download the Sentinel-2 scene...","categories": ["03 Remote Sensing basics"],
        "tags": ["Unit","03"],
